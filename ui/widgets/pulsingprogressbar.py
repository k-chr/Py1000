...
from . import (QProgressBar, QSize, QColor,QStyleFactory, QWidget,
...
class PulsingProgressBar(QProgressBar):
    ...
    def __init__(self, width: int, height: int, parent: QWidget =None):
        ...
        self.setStyleSheet("QProgressBar:horizontal {border: 1px solid gray;border-radius: 3px;" +
                            "background: white;padding: 1px;}" +
                            "QProgressBar::chunk {background: qlineargradient(x1: 0, y1: 0.5, x2: 1, y2: 0.5," +
                            " stop: 0 #05B8CC, stop: 1 white);}")
